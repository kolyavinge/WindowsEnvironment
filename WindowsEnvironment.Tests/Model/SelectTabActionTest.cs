...
internal class SelectTabActionTest
{
    ...
    {
        _panel.Tab.Add(_content);
        var tab = _panel.Tab.Add(_content);
        _panel.Tab.Add(_content);
        _panels.Setup(x => x.GetTabByName("tab_2")).Returns(tab);
    ...
    {
        var tab = _panel.Tab.Add(_content);
        _panels.Setup(x => x.GetTabByName("tab_1")).Returns(tab);
